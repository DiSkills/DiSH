#define TEST_ASSERT_LINE_WORD(LINE, LEN, SIZE, STR) \
    TEST_ASSERT_EQUAL_INT(LEN, LINE.word.len); \
    TEST_ASSERT_EQUAL_INT(SIZE, LINE.word.size); \
    TEST_ASSERT_EQUAL_STRING(STR, LINE.word.data);
...
#define FILL_LINE(LINE, IS_FINISHED, IS_ESCAPED, WORD_IS_EMPTY, ERROR, MODE) \
